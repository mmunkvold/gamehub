...
const buttonsUsed = document.querySelectorAll("#usedbutton");
console.log(usedbutton); //dette ser ut til å virke for denne... men hva med begge to?

buttonsUsed.forEach(function (button) {
